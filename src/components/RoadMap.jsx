...
const Roadmap = () => {
  return (
    <div className="lg:px-40 md:px-20 px-10 py-20">
      ...
      <ol data-aos="fade-up" class="relative text-gray-500 flex flex-col gap-10 border-s h-fit border-gray-200 dark:border-gray-700 dark:text-gray-400">
        <li class="mb-10 ms-6">
          <span class="absolute flex gap-2 items-center justify-center w-28 h-16 bg-black border-2 border-[#FFE500] -start-10 ">
            Phase
            <div className="bg-[#FFE500] text-black py-1 px-3 rounded-lg w-fit">
              1
            </div>
          </span>
          <div className="pl-20 pt-3">
            <h3 class="font-medium leading-tight">Deployment</h3>
            <p class="text-sm">
        ...
        <li class="mb-10 ms-6">
          ...
          <div className="pl-20 pt-3">
            <h3 class="font-medium leading-tight">Building the Foundation</h3>
            <p class="text-sm">
              <ul className="flex flex-col pt-5 gap-5">

...
const Roadmap = () => {
  return (
    <div className="lg:px-40 md:px-20 px-6 py-20">
      <h1 data-aos="fade-up" className="font-bold text-white text-center md:text-5xl text-3xl pb-10">
        Reward Token Road Map
      </h1>
      <ol data-aos="fade-up" class="relative md:flex hidden text-gray-500  flex-col gap-10  border-s h-fit border-gray-200 dark:border-gray-700 dark:text-gray-400">
        <li class="mb-10 ms-6">
          <span class="absolute flex gap-2 items-center justify-center -start-16 ">
  ...
  <img src="/phase2.svg" alt="" />
          ...
          <div className="pl-20 pt-3">
            <h3 class="font-medium leading-tight text-[#FFE500]">Building the Foundation</h3>
            <p class="text-sm">
              <ul className="flex flex-col pt-5 gap-5">
  ...
  <img src="/phase3.svg" alt="" />
      ...
      <ol data-aos="fade-up" class="relative flex md:hidden text-gray-500  flex-col gap-10 border-s border-e h-fit border-gray-200 dark:border-gray-700 dark:text-gray-400">
        <li class="mb-10">
<div className="flex items-start pr-5">
  <img src="/phase1.svg" alt="" />
</div>

  ...
  return (
    <div className="relative h-screen">
      <div className="flex justify-between lg:pl-40 md:pl-36 px-10 items-center h-full">
        <div className="relative flex flex-col gap-6 z-[1000] xl:w-[60%] lg:w-[65%]">
          ...
          <div className="flex md:flex-row flex-col md:items-center items-start gap-6">
            ...
            <button className="flex items-center justify-center bg-[#191919] text-yellow-400 py-3 px-8 font-medium rounded-lg">
              Join community
              <span>
                <TbCopyleftFilled />
              </span>{" "}
